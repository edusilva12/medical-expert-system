let cholesterol: Array<string> = [
  '¿Tiene vision borrosa?',
  '¿Tiene hinchazon en alguna extremidad?',
  '¿Tiene perdida del equilibrio?',
  '¿Tiene dolor de cabeza?',
  '¿Tiene amarillos los ojos?',
...
let parkinson: Array<string> = [
  '¿Presenta temblor en alguna de las extremidades superiores del cuerpo?',
  '¿Tiene dolores articulares?',
  '¿Ha notado algún cambio perdida de movimiento espontáneo y automático en alguna extremidad?',
